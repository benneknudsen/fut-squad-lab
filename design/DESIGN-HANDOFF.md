# 91c2d03a-9fff-4dad-967d-961a5f2466c5 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `logo.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `logo.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `logo.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `logo.html`
- `reference/vision.html`

## Styles
- `tokens.css`

## Scripts/components
- `tools/vision-smoke-test.js`

## Assets and supporting files
- `assets/icon-tile-16.svg`
- `assets/icon-tile.svg`
- `assets/icons/icon-128.png`
- `assets/icons/icon-16.png`
- `assets/icons/icon-32.png`
- `assets/icons/icon-48.png`
- `assets/icons/icon-512.png`
- `assets/logo-mark-16.svg`
- `assets/logo-mark.svg`
- `assets/wordmark-stacked.svg`
- `assets/wordmark.svg`
- `components.md`
- `copy.da.json`
- `copy.en.json`
- `README.md`
- `tools/contrast-check.py`

## Coding checklist for AI tools
1. Inspect `logo.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
